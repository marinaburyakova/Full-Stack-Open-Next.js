    ...
    <div className="max-w-xl mx-auto space-y-6 mt-6">
      ...
      >
        ...
        <div className="border-t border-slate-100 pt-6 space-y-4">
          <div className="grid grid-cols-3 gap-4 text-sm py-2 border-b border-slate-50">
            ...
            <span
              ...
              className="col-span-2 text-slate-800 font-semibold"
            >
          ...
          <div className="grid grid-cols-3 gap-4 text-sm py-2 border-b border-slate-50">
            ...
            <span
              ...
              className="col-span-2 text-slate-600 font-mono"
            >
        ...
        <div
          ...
          className="bg-slate-50 border border-slate-200/60 rounded-xl p-5 space-y-4"
        >
        ...
        >
          ...
          <div
            ...
            className="bg-white border border-slate-200 px-4 py-3 rounded-lg font-mono text-sm break-all text-slate-700 min-h-11.5 flex items-center"
          >
            {dbUser?.apiToken ? (
              <span
